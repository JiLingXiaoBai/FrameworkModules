...
{
    [EditorInfo("Composite:序列,依次遍历子结点,若返回Success则继续更新下一个,否则返回Failure")]
    [EditorLabel("Sequence序列")]
    public class Sequence : Composite
    {
        [SerializeField, Tooltip("当优先于当前运行结点的子结点判断改变时打断当前运行结点,打断会影响其分支下全部结点;注意:在此行为树中,Action结点的判断始终" +
